 ...
 (function( window, undefined ) {
    ...
    auiRange.prototype = {
        _init: function(params,callback) {
            ...
            params.element.insertAdjacentHTML('afterend','<div class="aui-range-tip aui-hide">'
                +params.element.value+'</div>');
        ...
        _showTip: function(el,callback){
            ...
            var Money=document.getElementById('item-id-money')
            // console.log(Money)
            el.aa='单位:'+el.value+'￥';
            //单位:el.value￥
            Money.innerText = el.aa;
            callback({
                // value:el.value
                Money:el.value
            });
