...
<head>
    ...
    <!--图片上传css-->
    <link rel="stylesheet" href="${path}/static/aui/mycss/imgupload1.css">
    <!--本页面css-->
...
<div class="container">
    ...
    <div class="z_photo z_p2 clearfix">
            ...
            <div class="z_file z_f2">
                <input type="file" name="video" id="video" value="" accept="video/*" multiple onchange="vidChange('z_p2','z_f2');" />
...
<div class="checkbox">
    ...
    <br>
    <input type="checkbox" class="checkbox-input"><span class="checkbox-text">私密提问，唯你能见专属答案</span>
</div>
    <!--提问按钮-->
<button class="button">￥50.00提问</button>
...
bfrows = bfrows	+ `<div class="expert clearfix">
  		          ...
  		          <div class="expert-text">
  		              <b style="color: #7a7a7a">`+ro.datas.desc+`</b>
  		          </div>
  		      </div>
  		           <p class="ask">*向 `+ro.datas.name+` 专家提问,等TA语音回答;超48小时,将支付路径全额退款</p>
  		  <div class="detail-text">
  		      <textarea placeholder="请输入您要提问的问题详情" id="textareadescid"></textarea>
  		  </div>`;
